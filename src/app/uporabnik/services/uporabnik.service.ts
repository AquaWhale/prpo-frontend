...
export class UporabnikService {
    ...
    create(uporabnik: Uporabnik, pkNapaka: any): Promise<Uporabnik> {
        return this.http
            .post<Uporabnik>(this.url, JSON.stringify(uporabnik), {headers: this.headers})
            .toPromise()
            .then(user => user as Uporabnik)
            .catch(err => pkNapaka(err));
    }
